...
# MAGIC %md
# MAGIC 1. CREATE TEMP VIEW WHICH WILL ACT AS SOURCE TO READ THE DATA
# MAGIC 2. THE SOURCE WILL READSTREAM THE DATA BACK TO SILVER.ORDERS TABLE
...
# MAGIC %sql
# MAGIC SELECT * FROM gold.daily_customers_books;
